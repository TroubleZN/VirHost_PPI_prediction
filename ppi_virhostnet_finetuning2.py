...
from src.modeling.ProtBertPPIModel2 import ProtBertPPIModel
...
from src.data.VirHostNetDataset import VirHostNetData2
...
def generate_parser():
    ...
    parser.add_argument(
        "--perform_training", default=False, type=bool, help="Perform training."
    )
    parser.add_argument(
        "--prediction_checkpoint",
        default=settings.BASE_MODELS_DIR + "/prot_t5_xl_bfd3.ckpt",
        # default="./lightning_logs/version_4224390/checkpoints/epoch=0-step=67.ckpt",
        type=str,
...
def main(params):
    ...
    if params.perform_training == True:
        ...
        model_params["nr_frozen_epochs"] = 1
        ...
        dataset = VirHostNetData2(train_data,
            tokenizer = tokenizer, 
            max_len = max_len, 
            seq_col_a = seq_col_a, 
            seq_col_b = seq_col_b, 
