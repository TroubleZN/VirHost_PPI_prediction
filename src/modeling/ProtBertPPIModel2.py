...
class ProtBertPPIModel(pl.LightningModule):
    ...
    def __init__(self, params) -> None:
        ...
        self.tokenizer_name = params.tokenizer_name
    ...
    def __build_model(self) -> None:
        ...
        self.ProtBertBFD = T5Model.from_pretrained(self.model_name)
        self.ProtBertBFD.gradient_checkpointing_enable()
        self.encoder_features = 1024

        # Tokenizer
        self.tokenizer = T5Tokenizer.from_pretrained(self.tokenizer_name, do_lower_case=False)
    ...
    def forward(self, input_ids, attention_mask):
        ...
        """
        word_embeddings = self.ProtBertBFD(input_ids, attention_mask, decoder_input_ids=input_ids)[2]
